...
import ActiveOrderBottomComponent from '../Components/ActiveOrderBottomComponent';
    ...
    <View style={styles.Container}>
      ...
      <View style={styles.shippingaddressContainer}>
        <Text style={styles.accountsettingText}>
          Active Orders {activeOrdesData?.products?.length}
        </Text>
      </View>
      <View style={{flex: 1}}>
        {cartLoading ? (
          ...
          <FlatList
            ...
            data={activeOrdesData?.activeOrders?.reverse()}
